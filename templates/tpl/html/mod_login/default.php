...
<form action="<?php echo JRoute::_('index.php', true, $params->get('usesecure')); ?>" method="post" id="login-form" >
    ...
    <div class="nav nav-list">
    	...
    	<span><a class="llast" href="<?php echo JRoute::_('index.php?option=com_users&view=registration'); ?>"><i class="icon-check"></i><?php echo JText::_('MOD_LOGIN_REGISTER'); ?></a></span>
    	<?php endif; ?>
    </div>
    <div class="clr"></div>
