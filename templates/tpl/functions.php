...
{
     $templatecopy = 'Design and theme by JooThemes.net - <a href="http://joothemes.net" title="Joomla Themes" target="_blank">Free Joomla Templates</a>.';
}
elseif (JRequest::getVar('view') == 'article')  
{
     $templatecopy = 'Design and theme by JooThemes.net - <a href="http://joothemes.net" title="Free Joomla Themes" target="_blank">Best Joomla Templates</a>.';
}
else
{ 
     $templatecopy = 'Design and theme by JooThemes.net - <a href="http://joothemes.net" title="Responsive Joomla Themes" target="_blank">Bootstrap Joomla Themes</a>.';
}
