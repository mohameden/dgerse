...
<!-- Google Font -->
<link href='http://fonts.googleapis.com/css?family=<?php echo $this->params->get('googleFont');?>:<?php echo $this->params->get('googleFontWeight');?>&subset=<?php echo $this->params->get('googleFontCharacter');?>' rel='stylesheet' type='text/css' />
...
<div id="header-w">
    ...
    <?php if ($logo != null ) : ?>
    <div class="logo"><a href="<?php echo $this->baseurl ?>"><img class="bloguslogo" src="<?php echo $this->baseurl ?>/<?php echo htmlspecialchars($logo); ?>" alt="<?php echo htmlspecialchars($templateparams->get('sitetitle'));?>" /></a></div>
    <?php else : ?>
    <div class="logo"><a href="<?php echo $this->baseurl ?>/"><img class="bloguslogo" src="<?php echo $this->baseurl; ?>/templates/<?php echo $this->template; ?>/images/logo.png" border="0" alt="<?php echo htmlspecialchars($templateparams->get('sitetitle'));?>"></a></div>
    <?php endif; ?><?php endif; ?> 
