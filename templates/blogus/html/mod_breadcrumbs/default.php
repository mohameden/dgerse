...
<ul class="breadcrumb<?php echo $moduleclass_sfx; ?>">
	...
	{
		echo '<li class="bhome">' . JText::_('MOD_BREADCRUMBS_HERE') . '&#160;</span></li>';
	}
	else
	{
	...
	if ($key != $last_item_key)
	{
		...
		if (!empty($item->link))
		{
			// Removed section: echo '<a href="' . $item->link . '" class="pathway">' . $item->name . '</a>';
			// Next line added instead:
	...
	elseif ($show_last)
	{
		...
		// Removed section: echo '<span>' . $item->name . '</span>';
		// Next line added instead:
