...
<div id="jm-coming-soon">
	<div class="container-fluid">
		...
		*/
		...
		<a class="button" href="<?php echo JURI::base(); ?>" title="<?php echo JText::_('TPL_JMTEMPLATE_JERROR_HOME_PAGE'); ?>" style="display: none;"><?php echo JText::_('TPL_JMTEMPLATE_JERROR_HOME_PAGE'); ?></a>
	</div>
</div>
